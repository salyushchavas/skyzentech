...
const STAFF_ROLE_LINKS: Record<UserRole, StaffLink[]> = {
  ...
  ERM: [
    ...
    { icon: FileText,       label: 'Document Templates',   href: '/careers/erm/document-templates' },
    { icon: ClipboardList,  label: 'Document Packets',     href: '/careers/erm/document-packets' },
    { icon: Inbox,          label: 'Review Queue',         href: '/careers/erm/document-review' },
