...
public class TimesheetController {
    ...
    @PreAuthorize("hasAnyRole('OPERATIONS', 'HR', 'TECHNICAL_EVALUATOR', 'REPORTING_MANAGER')")
    ...
    @PreAuthorize("hasAnyRole('OPERATIONS', 'TECHNICAL_EVALUATOR', 'REPORTING_MANAGER', 'SUPER_ADMIN')")
